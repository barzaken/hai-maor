                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex flex-col">
                    ...
                    <motion.p
                      ...
                      className="text-sm font-medium text-[#f5f511]"
                    >
                      {active.subtitle}
                    </motion.p>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5" key={feature}>
                    <div className="w-6 h-6 rounded-full bg-[#f5f511]/20 flex items-center justify-center text-[#f5f511] shrink-0">
                  ...
                  {tvShows.map((show, index) => (
                    ...
                    >
                      ...
                      <div className="absolute bottom-6 right-6 left-6 text-right">
                        ...
                        <p className="text-sm font-medium text-[#f5f511]">{show.subtitle}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
