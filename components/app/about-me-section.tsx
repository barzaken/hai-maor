...
const credentials = [
  'בוגר הסטודיו למשחק ע"ש יורם לוינשטיין',
  'בוגר לימודי משחק של איוונה צ׳אבק בארה״ב',
];
    ...
    <section dir="rtl" className="relative overflow-hidden py-12 md:py-16">
      ...
      <Container className="relative grid items-start gap-8 md:grid-cols-[1.1fr_1fr]">
        ...
        >
          ...
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">חי מאור</h2>
          <p className="mt-4 text-base leading-8 text-muted-foreground md:text-lg">
            שחקן תיאטרון, טלוויזיה וקולנוע כבר 20 שנה, וב-13 השנים האחרונות שחקן בתיאטרון בית ליסין.
            תפקידיו כוללים בין היתר את הסדרות{' '}
            <Highlighter action="underline" color="#f59e0b">&quot;קופה ראשית&quot;, &quot;השוטרים&quot;, &quot;מלכות&quot; ו&quot;חזרות&quot;</Highlighter>.
            מזה 15 שנה אני מאמן ומלווה שחקנים, מנהלים ויזמים לבניית נוכחות, ביטחון והשפעה -
        ...
        >
          ...
          <p className="text-sm text-muted-foreground">ניסיון במה מעשי</p>
