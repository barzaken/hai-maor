  ...
  return (
    <section id="leadership" className="relative py-24 md:py-32 bg-background overflow-hidden" dir="rtl">
      ...
      <div className="absolute inset-0 pointer-events-none -z-10">
        <div className="absolute top-0 right-1/4 w-[30rem] h-[30rem] bg-[#f0c246]/5 blur-[120px] rounded-full mix-blend-screen" />
      </div>
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="flex flex-col items-start max-w-3xl mb-16 md:mb-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#f0c246]10 border border-[#f0c246]/20 text-[#f0c246] text-sm font-medium mb-6"
          >
            ניהול
          </motion.div>
          <motion.h2
          ...
          {bentoItems.map((item, index) => (
            <motion.div
              ...
              className={cn(
                ...
                "shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.12)] hover:border-[#f0c246]/30 transition-all duration-500",
                item.className
              )}
            >
              {/* Background Image */}
              {item.image && (
                <div className="absolute inset-0 z-0">
                  <img
                    src={item.image}
                    alt={item.title}
                    className="w-full h-full object-cover opacity-40 transition-transform duration-700 group-hover:scale-110 group-hover:opacity-60" loading="lazy" decoding="async"
                  />
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 bg-[#f0c246]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />

              <div className="absolute top-8 right-8 w-12 h-12 rounded-2xl bg-[#f0c246]10 flex items-center justify-center border border-[#f0c246]/20 mb-auto text-[#f0c246] z-10">
