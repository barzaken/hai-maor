      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            >
              להפוך מילים <br />
              <span className="text-[#f5f511]">לתוצאות עסקיות.</span>
            </motion.h2>
            ...
            >
              {[
                ...
                >
                  <div className="w-1.5 h-1.5 rounded-full bg-[#f5f511]" />
            ...
            {salesPoints.map((point, i) => (
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-[0_4px_24px_rgba(0,0,0,0.4)] transition-all duration-500 hover:border-[#f5f511]/50",
                  i === 2 ? "sm:col-span-2" : ""
                )}
              >
                {/* Hover Tint */}
                <div className="absolute inset-0 bg-[#f5f511]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                <div className="w-12 h-12 rounded-xl bg-[#f5f511]/10 flex items-center justify-center mb-6 text-[#f5f511] border border-[#f5f511]/20">
