...
const tracks = [
  {
    title: 'סדנה יומית',
    desc: 'סדנה המועברת על גבי יום שלם בה אלמד אתכם את יסודות ועיקרונות הפרזנטציה ועמידה מול קהל ומצלמה.',
  },
  {
    title: 'אומנות הפרזנטציה - 6 מפגשים',
    desc: 'חבילה מלאה לבניית נוכחות, מסר וביצוע ברמה עקבית ומקצועית.',
  },
  {
    title: 'דרך משותפת',
    desc: 'יוצאים לדרך משותפת ללא הגבלת זמן אך עם מטרה אחת ברורה - להפוך אתכם לאנשים שיכולים להוביל - פרוייקט, צוות, הרצאה או כל ממשק עסקי.',
  },
];
