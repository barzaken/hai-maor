	...
	return (
		<section className="relative py-24 md:py-32 w-full overflow-hidden" dir="rtl">
			...
			<div className="absolute inset-0 pointer-events-none -z-10">
				...
				<div className="absolute bottom-0 left-1/4 w-[20rem] h-[20rem] bg-[#f0c246]/5 blur-[100px] rounded-full mix-blend-screen" />
			</div>
					...
					{items.map((item, i) => (
						...
						>
							...
							<div className="absolute inset-0 z-0 pointer-events-none">
								<div className="absolute inset-[-1px] rounded-[2.5rem] border border-[#f0c246]/15 group-hover:border-[#f0c246]/40 transition-colors duration-500" />
							</div>
